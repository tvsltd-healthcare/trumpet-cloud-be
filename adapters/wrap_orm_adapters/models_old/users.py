...
# from adapters.wrap_orm_adapters.models import OrganizationUsers
...
class Users(Base):
    ...
    status = Column(Enum('approved', 'disapproved', 'blocked', 'pending_registration', name='status_enum'), nullable=True, default='pending')
