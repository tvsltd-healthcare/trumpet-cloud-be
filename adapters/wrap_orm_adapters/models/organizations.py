...
class Organizations(Base):
    ...
    status = Column(Enum('approved', 'disapproved', 'blocked', 'pending_approval', name='status_enum'), nullable=True, default='pending_approval')
    type = Column(Enum('data_owner', 'researcher', name='type_enum'), nullable=True,)
