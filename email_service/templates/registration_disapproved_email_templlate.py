DISAPPROVED_REGISTRATION_EMAIL_TEMPLATE = """
<!DOCTYPE html>
<html>
<head>
    <style>
        ...
        h1 {{ font-size: 24px; color: #a60000; margin-bottom: 20px; }}
...
<body>
    ...
    <div class="content">
        ...
        <p>Dear User,</p>
        <p>We are sorry. Your registration has not been approved.</p>
        <p>Please verify your documents and try again.</p>
